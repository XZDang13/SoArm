...
dome = DomeLight(
    paths="/World/DomeLight",
    #texture_files=assets_root_path + "/Isaac/Materials/Textures/Patterns/nv_brick_tile.jpg",            # any accessible HDR/HDRI
    #texture_formats="automatic",                                # or "automatic"
)
