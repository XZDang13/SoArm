...
def get_robot_joint_properties(
    ...
    """
    actuator_data = data.get("robot").get("actuators")
    stiffness = {}
    damping = {}
    effort_limits = {}
    velocity_limits = {}
    ...
    init_joint_pos = data.get("robot").get("init_state").get("joint_pos")
    ...
    init_joint_vel = data.get("robot").get("init_state").get("joint_vel")
...
def get_articulation_props(data: dict) -> dict:
    ...
    """
    return data.get("robot").get("spawn").get("articulation_props")
